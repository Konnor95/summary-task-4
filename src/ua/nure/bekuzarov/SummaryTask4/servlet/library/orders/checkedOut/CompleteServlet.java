...
/**
 * Responsible for completing orders (returns book back to library).
 */
@WebServlet(Actions.Library.CheckedOut.COMPLETE)
public class CompleteServlet extends LibraryServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        forward(Pages.Library.CheckedOut.COMPLETE, req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        redirectToAction(Actions.Library.CheckedOut.LIST, req, resp);
    }
    ...
    private Order getOrder(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (order == null || order.getType() != OrderType.CHECKED_OUT) {
            redirectBack(req, resp);
            return null;
        }
        return order;
