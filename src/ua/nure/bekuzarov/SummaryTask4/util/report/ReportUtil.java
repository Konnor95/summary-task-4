package ua.nure.bekuzarov.SummaryTask4.util.report;
...
public abstract class ReportUtil {
    ...
    private static final String FOLDER = "/templates/reports/";
     ...
     * @throws FileException if cannot generate report
     */
    public Report generate(String reportName, String locale) {
        try {
            ...
            if (type == null) {
                throw new FileException("Unknown report extension");
            }
