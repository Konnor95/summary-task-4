                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <c:forEach items="${requestScope.orders}" var="order">
                                <tr>
                                    ...
                                    <td>
                                        <a href="<t:url value="/library/orders/checked-out/complete"/>?id=${order.id}">
