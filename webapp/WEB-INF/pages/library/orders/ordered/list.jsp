...
<lb:layout title="${title}">
     <jsp:attribute name="actionButtons">
        <button type="button" class="btn btn-primary link-button">
            <a href="<t:url value="/library/orders/ordered/report.odt"/>">
                <i class="fa fa-file-word-o"> </i> ODT
            </a>
        </button>
         <button type="button" class="btn btn-danger link-button">
             <a href="<t:url value="/library/orders/ordered/report.pdf"/>" target="_blank">
                      ...
                      <table class="table table-bordered table-hover">
                          ...
                          <c:forEach items="${requestScope.orders}" var="order">
                              <tr>
                                  ...
                                  <td>
                                      <a href="<t:url value="/library/orders/ordered/accept"/>?id=${order.id}">
                                          <fmt:message key="text.accept"/>
                                      </a>
                                  </td>
                              </tr>
                          </c:forEach>
