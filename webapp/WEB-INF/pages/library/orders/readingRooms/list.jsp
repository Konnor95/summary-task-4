                      ...
                      <table class="table table-bordered table-hover">
                          ...
                          <c:forEach items="${requestScope.orders}" var="order">
                              <tr>
                                  ...
                                  <td>
                                      <a href="<t:url value="/library/orders/reading-rooms/complete"/>?id=${order.id}">
                                          <fmt:message key="text.complete"/>
                                      </a>
                                  </td>
                              </tr>
                          </c:forEach>
