...
{});for(var b in a)g[b]=a[b]};c.init=function(a){null==a&&(a=e);var b=a.onload||new Function;a.onload=function(){var a=document.getElementsByTagName("img"),e=[],d,c;for(d=0;d<a.length;d++)c=a[d],e.push(new f(c));b()}};c.isRetina=function(){return 1<e.devicePixelRatio||e.matchMedia&&e.matchMedia("(-webkit-min-device-pixel-ratio: 1.5),                      (min--moz-device-pixel-ratio: 1.5),                      (-o-min-device-pixel-ratio: 3/2),                      (min-resolution: 1.5dppx)").matches?
